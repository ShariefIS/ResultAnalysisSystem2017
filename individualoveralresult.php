...
onclick="window.print();return false;" /></form>        
  ...
  <tr>
      <th align="center" colspan="6">OU Individual Result March 2017</th>
  </tr>
  ...
  <tr>
      <th>Class :</th>
    <td align="center">B . E  ( <?php echo $v1;?> / 4 )  I T D </td>
    <th>Section: </th>
     <?php
  ...
  <tr>
      <th>S.no</th>
        ...
        $sql="SELECT sname, emarks, imarks, IFNULL(emarks,0)+imarks as total , sresult
                FROM marks_info_it
                WHERE  marks_info_it.rno=$v3"; 
  ...
  <?php while ($row = mysqli_fetch_assoc($result)): ?>
    <?php 
     echo 
        ...
        <td align=\"center\">{$row["sresult"]}</td>
        </tr>";
    ?>
    <?php $i++ ?>
    <?php endwhile;?>
