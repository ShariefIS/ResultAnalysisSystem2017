...
<table align="center" border="3">
  <tr>
      <th align="center" colspan="8">OU Subject Wise March-2017 Results</th>
  </tr>
  <tr>
      <th>Subject : </th>
  ...
  <tr>
   ...
   <?php
        ...
        $sql="SELECT section, student_list.rno as rno, name, emarks, imarks, IFNULL(emarks,0)+imarks as total, sresult
                FROM marks_info_it,student_list
                WHERE scode=$v4
                AND
               marks_info_it.rno in(select rno from student_list where section in ('$v3') and year=$v1)
