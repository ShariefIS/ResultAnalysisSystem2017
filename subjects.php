...
<center>
<h3>Subject Wise Result 2017</h3>
</center>
    <div>
...
<?php
        ...
        $sql="SELECT scode, sname FROM subjects WHERE syear=$v1 and ssem=$v2"; 
        ...
        <form action="subjectresult.php" method="POST">
            ...
            <br></br>
            <input type="hidden" value="<?php echo htmlspecialchars($_POST["year"]);?>" name="year">
